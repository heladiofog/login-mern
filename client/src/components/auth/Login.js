...
import { loginUser } from '../../actions/authActions'; // action registerUser
...
class Login extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps.auth.isAuthenticated) {
      this.props.history.push("/dashboard");  // push user to dashboard when thet login
    }
  ...
  // Some flow logic
  componentDidMount() {
    // If a user is logged in and (user) navigates to Login page,
